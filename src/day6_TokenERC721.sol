...
//最新版openzepplin的Address没有isContract方法
//import "https://github.com/OpenZeppelin/openzeppelin-contracts/blob/v4.9.6/contracts/utils/Address.sol";
...
contract TokenERC721 {
    ...
    uint256 private _tokenIds;//auto-increment
     ...
     */
    function mint(address to,string memory cid) public returns (uint256){
