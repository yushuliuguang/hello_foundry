...
contract NFTMarketScript is BaseScript {
    ...
    // 用于 create2 部署的盐值
    bytes32 public constant MARKET_SALT = keccak256("NFTMarket_Deployment_v3");
    ...
    function run() public broadcaster {
        ...
        //tokenContract= TokenERC20(0x96553571B261aDB41cCe6a45eFB0679cD2375F30);
        //tokenContract.balanceOf(0x96553571B261aDB41cCe6a45eFB0679cD2375F30);
        market = new NFTMarket{salt:MARKET_SALT}(address(tokenContract));
        //market = NFTMarket(0xCf196056811c13F5e5C21656C530A01523C82cB3);
        //market.priceList(0);
